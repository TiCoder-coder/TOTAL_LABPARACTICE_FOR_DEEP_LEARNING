...
**Acknowledgement:** Đã đọc, thấu hiểu và cam kết tuân thủ chi tiết từng rule trong số 19 rule files (`1.md`, `3.md`–`20.md` với `trigger: always_on`). Đã truyền đạt và thiết lập bắt buộc cho mọi agent/subagent. Tuyệt đối không suy diễn, không tự ý sửa đổi ngoài phạm vi được duyệt và luôn đánh giá trung thực sau khi hoàn thành.
