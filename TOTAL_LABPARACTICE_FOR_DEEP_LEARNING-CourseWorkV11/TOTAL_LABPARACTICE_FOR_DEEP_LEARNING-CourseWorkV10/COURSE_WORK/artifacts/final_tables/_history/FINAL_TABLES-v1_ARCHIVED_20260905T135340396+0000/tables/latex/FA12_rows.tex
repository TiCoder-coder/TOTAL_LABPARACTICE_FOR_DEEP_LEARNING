\begin{table}[h!]
\centering
\caption{FA12 - Upstream Warnings and Reporting Caveats}
\label{tab:fa12\_-\_upstream\_warnings\_and\_reporting\_caveats}
\begin{tabular}{lrrr}
\toprule
caveat\_title & caveat\_description & propagated\_to\_table & source\_phase \\
\midrule
...
\end{tabular}
\vspace{4pt}
\footnotesize{Caveats propagated from upstream phases.}\\
\end{table}
