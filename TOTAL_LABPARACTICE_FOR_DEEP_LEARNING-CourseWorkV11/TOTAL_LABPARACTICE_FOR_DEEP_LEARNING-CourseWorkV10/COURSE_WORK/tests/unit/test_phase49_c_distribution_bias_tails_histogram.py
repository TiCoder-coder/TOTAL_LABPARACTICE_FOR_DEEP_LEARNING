...
from course_work.analysis.residual_analysis.bias import (
    _sign_label_exact,
    recompute_sign_class,
    sign_balance_rows,
    signed_bias_for_residuals,
)
from course_work.analysis.residual_analysis.c_writers import snapshot_phase49_b_artifacts
...
from course_work.analysis.residual_analysis.histogram import (
    PHASE49_HISTOGRAM_BINS,
    compute_common_bin_edges,
    compute_histogram_rows,
    histogram_invariants,
)
from course_work.analysis.residual_analysis.materialize_c import SEED_LIST, materialize_phase49_c
from course_work.analysis.residual_analysis.tails import compute_tail_diagnostics
...
def test_phase47_source_unchanged(phase49_c_manifest):
    ...
    from course_work.analysis.residual_analysis.sources import load_prediction_checksums, compute_seed_bundle_sha256
