...
from course_work.analysis.residual_analysis.cross_seed import (
    SEED_PAIRS,
...
from course_work.analysis.residual_analysis.magnitude_associations import (
    compute_magnitude_associations,
    pearson,
    spearman,
)
from course_work.analysis.residual_analysis.materialize_e import SEED_LIST, materialize_phase49_e
from course_work.analysis.residual_analysis.persistence_context import (
    compute_persistence_residual_context,
    load_persistence_rows,
    verify_persistence_against_phase47,
)
from course_work.analysis.residual_analysis.prediction_deciles import (
...
def test_persistence_checksum_exact(phase49_e_manifest):
    ...
    from course_work.analysis.residual_analysis.sources import load_prediction_checksums, sha256_file as src_sha256_file
