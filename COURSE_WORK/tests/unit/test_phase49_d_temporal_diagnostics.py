...
from course_work.phase49.autocorrelation import (
...
from course_work.phase49.ljung_box import (
    PHASE49_LJUNG_BOX_LAGS,
    PHASE49_LJUNG_BOX_POLICY,
    ljung_box_for_seed,
)
from course_work.phase49.materialize_d import SEED_LIST, materialize_phase49_d
from course_work.phase49.rolling import (
    PHASE49_ROLLING_WINDOW_SAMPLES,
    rolling_residual_diagnostics,
)
from course_work.phase49.sign_runs import sign_runs_for_seed
from course_work.phase49.sign_transitions import (
    SIGN_LABELS,
