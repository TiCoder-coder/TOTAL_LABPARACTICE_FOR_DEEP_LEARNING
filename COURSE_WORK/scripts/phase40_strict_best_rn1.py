...
from course_work.data.datasets import build_train_validation_loaders  # noqa: E402
from course_work.data.scaling import (  # noqa: E402
    inverse_transform_target,
    load_validated_scaler_bundle,
    load_validated_target_scaler,
)
from course_work.evaluation.metrics import EvaluationMode, compute_regression_metrics  # noqa: E402
...
from course_work.models.transformer_regressor import TransformerRegressor  # noqa: E402
from course_work.utils.artifacts import read_json  # noqa: E402
...
def main():
    ...
    # Hard gate: if the recorded device is not available on this host,
    # Option A forbids CPU fallback. Try the external Human-verified report
    # first; if present and valid, use it as PASS evidence. Otherwise emit
    # NOT_VERIFIABLE_ON_CURRENT_DEVICE without any CPU recomputation.
