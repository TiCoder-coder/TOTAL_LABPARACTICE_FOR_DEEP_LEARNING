...
# Path resolution: support both module-style and direct script invocation
...
def main() -> int:
    ...
    # Pre-corrective Phase47 lineage references (stale, post-corrective must
    # NOT inherit from these).
    ...
    # Active Phase47 artifacts to consider for archive. We include every
    # top-level file in artifacts/final_test/ that is not part of an
    # existing _archive*/.archive/ structure.
    ...
    # Add also the figures/ and predictions/ directories (read-only inventory).
