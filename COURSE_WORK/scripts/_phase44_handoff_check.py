...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="phase44_handoff_") as tmp:
        ...
        # The orchestrator returns phase45_handoff via RealRunResult
        ...
        # 1. recommended_transformer_candidate_id present and non-empty
        ...
        # 2. canonical candidate fingerprint (recommended_transformer_fingerprint)
        ...
        # 3. RO1/RO2/RO3 Stage A run ids, no nulls
        ...
        # 4. RO1/RO2/RO3 Stage B run ids, no nulls
        ...
        # 5. RO1/RO2/RO3 best_epoch_inner, no nulls, no fallback (epoch >= 1)
        ...
        # 8. ready_for_phase45 / approved_for_phase45
