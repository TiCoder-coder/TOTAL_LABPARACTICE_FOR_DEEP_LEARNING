...
from course_work.phase47.writers import _validate_json_serializable, FINAL_TEST_DIR
...
def main() -> int:
    ...
    # Gate 1: Phase46 release
    print("--- GATE 1: Phase46 Release ---")
    # Use CANONICAL path resolver. No fallback to wrong locations.
    ...
    # Gate 4: Checkpoint verification
    ...
    # Gate 5: FINAL_SCALING verification
    ...
    # Gate 10: Signoff cannot PASS before Test
    print("--- GATE 10: Signoff Gate Integrity ---")
    from course_work.phase47.writers import write_signoff
    import inspect
    ...
    # Gate 11: Test access authorization check
    ...
    # Gate 13: Test fingerprint producer defined
    ...
    # Gate 14: Stale artifact quarantine
    print("--- GATE 14: Stale Artifact Handling ---")
    # Check that .archive directory structure exists in Phase46 artifacts
    ...
    # Gate 14b: Path resolver verification
