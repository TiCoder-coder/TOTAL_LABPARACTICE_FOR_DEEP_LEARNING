...
# S1: Feature-Set Sweep (FS0_TF0, FS1_TF0, FS2_TF0, FS0_TF1, FS1_TF1, FS2_TF1)
_s1 = [
...
# S3: Target-Scaling Sweep (YS0=raw, YS1=log1p, YS2=standard)
_s3 = [
...
# S4: Lookback Sweep (L24, L48, L72, L144, L288)
_s4 = [
...
# S5: Pooling Sweep (LAST_STEP, MEAN, MAX)
_s5 = [
...
# S6: Activation Sweep (RELU, GELU, SILU)
_s6 = [
...
# S7: Batch Size Sweep (B16, B32, B64, B128) -- already have B32 real
_s7 = [
...
# S8: Learning Rate Sweep (LR1=1e-4, LR2=5e-4, LR3=1e-3, LR4=5e-3)
_s8 = [
