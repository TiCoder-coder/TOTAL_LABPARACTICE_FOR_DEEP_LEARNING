...
# ---------------------------------------------------------------------------
# CSS — reuses Phase49/50/51/52 .cw-d family
# ---------------------------------------------------------------------------
_CSS = """
<style>
...
def render_phase_53_dashboard(project_root: Path | str | None = None) -> HTML:
    ...
    # ----- ONE representative attention heatmap -----
    # Selection rationale (NOT a best-head claim):
    #   - TGT_00019582 = representative worst-error case (rank-1 W2 shared)
    #   - Layer 1 Head 1 = first head in canonical ordering, no rank basis
    #   - FIXED_PROBABILITY scale = comparable across heads/cases
    #   - Seed 42 = first canonical seed, no cherry-pick
    fig_rel = (
