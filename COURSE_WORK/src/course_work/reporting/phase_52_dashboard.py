...
# ---------------------------------------------------------------------------
# CSS — reuses Phase49/50/51 .cw-d family
# ---------------------------------------------------------------------------
_CSS = """
<style>
...
def render_phase_52_dashboard(project_root: Path | str | None = None) -> HTML:
    ...
    # Frozen dense and last-query shapes verified directly from raw NPZ
    # (Phase 52 only records; tensors themselves are not recomputed here).
