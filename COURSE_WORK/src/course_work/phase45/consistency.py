...
def check_o45_artifacts_complete(artifacts_dir) -> CheckResult:
    # phase_45_signoff.json is written AFTER preflight (signoff is the output, not an input).
    # It is therefore excluded from this completeness check.
...
# Map check codes to functions. Each is invocable from a context dict.
ACCEPTANCE_CHECKS = [
...
# Artifact name list — imported by artifacts.py to verify completeness.
ARTIFACT_NAMES = {
    # Lock contract
