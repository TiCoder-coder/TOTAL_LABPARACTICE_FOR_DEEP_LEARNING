...
EPS_H = 1e-12  # numerical epsilon inside log only
ROW_SUM_ATOL = 1e-5
ROW_SUM_RTOL = 1e-5
...
# Reproducibility probe size
REPRODUCIBILITY_PROBE_CASES = 2

# Top-K sources for top-source summary
TOP_K_SOURCES = 5
...
def load_frozen_sources(project_root: Path) -> FrozenSources:
    ...
    # Phase 47 signoff + prediction bundles
    ...
    # Verify final lock SHA matches one present in config lineage
    ...
    # Phase 46 three-seed checkpoints
