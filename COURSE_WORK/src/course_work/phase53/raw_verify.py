...
def verify_raw_dense_sources(sources: FrozenSources53, expected_shas: dict) -> dict:
    ...
    for seed in SEEDS:
        ...
        try:
            ...
            row_sums = arr.sum(axis=-1)  # sum over source axis
            ...
            # Probability recheck (lightweight, dense case set is small)
            ...
            # Row sum ≈ 1, allow tiny tolerance
            row_sum_ok = (
