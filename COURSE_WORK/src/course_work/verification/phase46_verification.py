...
def attention_compatibility_probe(
    ...
    # Only transformer has forward_with_attention; skip otherwise.
...
def cross_seed_consistency(
    ...
    # Each dimension is verified across the three seeds.
    ...
    # Build config_sha, recipe_sha, lock_sha, population_fp, scaler SHAs lists.
