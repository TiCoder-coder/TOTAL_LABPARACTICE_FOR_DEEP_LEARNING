...
Usage:
    PYTHONPATH=src python3 -c "from course_work.phase54.orchestrator import run_phase54; from pathlib import Path; run_phase54(Path('/path/to/project'))"
"""
...
from course_work.phase54 import (  # noqa: E402
...
from course_work.phase54.contract import write_analysis_contract  # noqa: E402
from course_work.phase54.sources import lag_steps_array  # noqa: E402  # re-exported
from course_work.phase54.top1_freq import (  # noqa: E402
    build_top1_lag_frequency,
    build_top1_tie_summary,
)
from course_work.phase54.writers import write_csv_atomic, write_json_atomic  # noqa: E402
...
def run_phase54(project_root: Path) -> dict:
    ...
    from course_work.phase54.finalize_phase54 import finalize_phase54 as _finalize
