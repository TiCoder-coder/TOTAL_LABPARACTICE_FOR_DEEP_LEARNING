...
# Phase45 lock artifacts (READ-ONLY from Phase47)
FINAL_MODEL_LOCK_DIR = "artifacts/final_model_lock"

# Phase46 final-run artifacts (READ-ONLY from Phase47)
THREE_SEED_FINAL_RUNS_DIR = "artifacts/three_seed_final_runs"

# Phase46 Phase47 gate artifacts (READ-ONLY from Phase47)
...
# ============================================================================
# Canonical Artifact Paths (Phase46 → Phase47 gate)
# ============================================================================

# --- PHASE46 Signoff ---
# Canonical: artifacts/three_seed_final_runs/phase_46_signoff.json
# NOT: artifacts/final_model_lock/phase_46_signoff.json  (that is Phase45 signoff!)
...
# --- Phase47 Test Release ---
# Canonical: artifacts/three_seed_final_runs/phase47_test_release.json
...
# --- Phase47 Final Test Evaluation Handoff ---
# Canonical: artifacts/three_seed_final_runs/phase47_final_test_evaluation_handoff.json
...
# --- Phase45 Signoff (READ-ONLY reference) ---
# Canonical: artifacts/final_model_lock/phase_45_signoff.json
...
# --- Phase46 Three-Seed Handoff (READ-ONLY reference) ---
# Canonical: artifacts/final_model_lock/phase46_three_seed_handoff.json
...
# --- FINAL_SCALING Registry ---
# Canonical: artifacts/scaling/final_dev/final_scaler_registry.json
...
# --- Window Index ---
# Canonical: artifacts/windows/window_index.csv
...
# Canonical: artifacts/feature_sets/feature_set_registry.json
...
# --- Feature View ---
# Canonical: artifacts/features/feature_view.parquet
...
# ============================================================================
# Canonical Three-Seed Checkpoint Paths
# ============================================================================
...
# ============================================================================
# Verification Functions (fail-fast)
# ============================================================================
...
def verify_phase46_release_for_phase47(
    ...
    # Step 1: Locate phase_46_signoff.json
    ...
    # Step 8: Locate phase47_test_release.json
    ...
    # Step 10: Locate phase47_final_test_evaluation_handoff.json
