...
def load_verified_transformer_checkpoint(
    ...
    # Step 5: Verify FINAL_REFIT_EPOCHS
    ...
    # Step 6: Verify final_lock_sha256
    ...
    # Step 8: Verify checkpoint seed matches
    ...
    # Step 10: Verify scaler checksums
...
def build_transformer_model_from_checkpoint(
    ...
    # Inject LOCKED_FEATURES as input_size.
    # The checkpoint model_config does NOT store input_size; TransformerModelConfig
    # defaults input_size=31 (FS1_TF1). Phase46 uses FS2_TF1 with 33 features.
    # If input_size is absent, use the canonical LOCKED_FEATURES (33).
    ...
    # Verify that input_size was correctly set to LOCKED_FEATURES
    ...
    # Verify state_dict keys match model keys
...
def verify_lstm_checkpoint(
    ...
    result = {
        ...
        "FINAL_TEST_POP_supported": False,  # L36 vs L72 mismatch
    ...
    # LSTM uses different lookback (36 vs 72) so FINAL_TEST_POP-v1 comparison
    # requires the L36-specific Test windows (not the same as L72 FINAL_TEST_POP-v1)
