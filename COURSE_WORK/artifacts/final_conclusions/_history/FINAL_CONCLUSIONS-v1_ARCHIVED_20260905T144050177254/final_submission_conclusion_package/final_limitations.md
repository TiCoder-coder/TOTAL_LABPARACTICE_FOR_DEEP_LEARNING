...
Attention describes temporal token allocation only — NOT raw-feature importance and NOT causation explanation.

Why it matters: Misreading attention as feature importance or as causation would overclaim.

Restricted claims: Cannot be used for causationstyle interpretation or causation-style feature-attribution claims.
...
Restricted claims: Cannot be marked as suitable for immediate prospective deployment without separate validation evidence.
