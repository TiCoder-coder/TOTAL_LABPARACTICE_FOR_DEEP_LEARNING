...
Presentation copy: [`../notebooks/04_canonical_report.ipynb`](../notebooks/04_canonical_report.ipynb) · [HTML report](../reports/html/practice_2_2_canonical_report.html)

Phase 6 authority: `configs/canonical_registry.json` resolves `data/final/`,
`data/manifests/`, `artifacts/canonical/` and `artifacts/ablations/`. Old paths
remain compatibility/pre-migration sources only.
