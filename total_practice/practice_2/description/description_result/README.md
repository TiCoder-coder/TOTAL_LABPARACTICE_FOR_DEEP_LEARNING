...
This index follows the current 54-cell
...
| 4 — EDA | 7–32 | RGB statistics, quality audit, PCA/t-SNE | [Phase 4](phase_04_results.md) |
| 5 — Preprocessing | 33–34 | Train-only stochastic transforms | [Phase 5](phase_05_results.md) |
| 6 — Model | 35–36 | ResNet18 parameter sanity checks | [Phase 6](phase_06_results.md) |
| 7 — Training | 37–38 | 25-epoch winner log and four-panel dashboard | [Phase 7](phase_07_results.md) |
| 8 — Hyperparameters | 39–40 | Three LR pairs and three heads | [Phase 8](phase_08_results.md) |
| 9 — Selection | 41–44 | Loss-selected SHA256 lock and PASS | [Phase 9](phase_09_results.md) |
| 10 — Final Test | 45–46 | 94.06% accuracy; per-class and ROC/PR | [Phase 10](phase_10_results.md) |
| 11 — Dashboard & Error Analysis | 47–52 | Single-file HTML dashboard, confidence, confusion and galleries | [Phase 11](phase_11_results.md) |
| 12 — Conclusion | 53–54 | Reproducible locked result | [Phase 12](phase_12_results.md) |
